...
"[project]/app/api/final/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request) {
    ...
    if (ce_config === "") {
        ...
        await db.run('UPDATE ejemplo  SET ce_config=? WHERE id=?', [
            ce_config,
            eId
        ]);
    } else {
        await db.run('UPDATE ejemplo  SET ce_config=?,leyenda=? WHERE id=?', [
            ce_config,
            leyenda,
            eId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71a00e82._.js.map